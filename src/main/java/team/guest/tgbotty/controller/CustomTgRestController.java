...
public class CustomTgRestController {
    ...
    @Autowired
    public CustomTgRestController(WebhookBot... webHookBots) {
    ...
    public Object updateReceived(@PathVariable String path, @RequestBody Update update) {
        ...
        try {
            ...
            return response;
        } catch (TelegramApiValidationException exception) {
            throw new IncorrectBotResponseException(path, response, exception);
        }
    }
